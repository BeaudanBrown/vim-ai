...
def make_openai_options(options):
    ...
    return {
        'model': options['model'],
        'max_tokens': max_tokens if max_tokens > 0 else max_completion_tokens if max_completion_tokens > 0 else None,
        'max_completion_tokens': max_completion_tokens if max_completion_tokens > 0 else None,
